...
import "../styles/aboutTheEvent.css";
  ...
  return (
    <div className="about-the-event">
      ...
      <strong>Ready Set Grow</strong> is a week-long series of career and profile-building
        ...
        and self-empowerment. Bounded by the purpose of creating and launching
        the path to their career, we also aim to motivate them in attaining
        their future employment in the sector and recognize their own value as
